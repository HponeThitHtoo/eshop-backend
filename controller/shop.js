  ...
  try {
    ...
    try {
      await sendMail({
        ...
        message: `Hello ${seller.name}, please click on the link to activate your shop: ${activationUrl}. Your token will expires in 10 minutes.`,
      });
      res.status(201).json({
        success: true,
        message: `please check your email:- ${seller.email} to activate your shop! The token will expire in 10 minutes.`,
      });
    } catch (error) {
...
router.post(
  ...
  catchAsyncErros(async (req, res, next) => {
    try {
      ...
      // console.log("find_seller", seller);
      ...
      // console.log("created_seller", seller);
