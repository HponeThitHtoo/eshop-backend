  ...
  try {
    ...
    try {
      await sendMail({
        ...
        message: `Hello ${user.name}, please click on the link to activate your account: ${activationUrl}. Your token will expires in 10 minutes.`,
      });
      res.status(201).json({
        success: true,
...
router.put(
  ...
  catchAsyncErros(async (req, res, next) => {
    try {
      ...
      // ! check for same address (I think this is wrong concept)
